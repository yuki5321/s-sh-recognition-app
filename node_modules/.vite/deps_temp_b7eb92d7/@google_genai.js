...
var jsonSchemaTypeValidator = v3_exports.enum([
  "string",
  "number",
  "integer",
  "object",
...
var schemaTypeUnion = v3_exports.union([
  jsonSchemaTypeValidator,
  v3_exports.array(jsonSchemaTypeValidator)
]);
function createJsonSchemaValidator(strictMode = true) {
  const jsonSchemaValidator = v3_exports.lazy(() => {
    const baseShape = v3_exports.object({
      // --- Type ---
      type: schemaTypeUnion.optional(),
      // --- Annotations ---
      format: v3_exports.string().optional(),
      title: v3_exports.string().optional(),
      description: v3_exports.string().optional(),
      default: v3_exports.unknown().optional(),
      // --- Array Validations ---
      items: jsonSchemaValidator.optional(),
      minItems: v3_exports.coerce.string().optional(),
      maxItems: v3_exports.coerce.string().optional(),
      // --- Generic Validations ---
      enum: v3_exports.array(v3_exports.unknown()).optional(),
      // --- Object Validations ---
      properties: v3_exports.record(v3_exports.string(), jsonSchemaValidator).optional(),
      required: v3_exports.array(v3_exports.string()).optional(),
      minProperties: v3_exports.coerce.string().optional(),
      maxProperties: v3_exports.coerce.string().optional(),
      propertyOrdering: v3_exports.array(v3_exports.string()).optional(),
      // --- Numeric Validations ---
      minimum: v3_exports.number().optional(),
      maximum: v3_exports.number().optional(),
      // --- String Validations ---
      minLength: v3_exports.coerce.string().optional(),
      maxLength: v3_exports.coerce.string().optional(),
      pattern: v3_exports.string().optional(),
      // --- Schema Composition ---
      anyOf: v3_exports.array(jsonSchemaValidator).optional(),
      ...
      additionalProperties: v3_exports.boolean().optional()
    });
